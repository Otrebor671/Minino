...
zip $FINAL_BUILD_DIR/minino_$PROJECT_VERSION.zip $FINAL_BUILD_DIR/minino_$PROJECT_VERSION.bin
zip $FINAL_BUILD_DIR/bsides_$PROJECT_VERSION.zip $FINAL_BUILD_DIR/bsides_$PROJECT_VERSION.bin
zip $FINAL_BUILD_DIR/dragonjar_$PROJECT_VERSION.zip $FINAL_BUILD_DIR/dragonjar_$PROJECT_VERSION.bin
zip $FINAL_BUILD_DIR/ekoparty_$PROJECT_VERSION.zip $FINAL_BUILD_DIR/ekoparty_$PROJECT_VERSION.bin
zip $FINAL_BUILD_DIR/bugcon_$PROJECT_VERSION.zip $FINAL_BUILD_DIR/bugcon_$PROJECT_VERSION.bin
